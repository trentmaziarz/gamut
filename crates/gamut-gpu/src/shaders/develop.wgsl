...
// and saturation. Every function mirrors its twin in gamut-color line for
...
// magenta through the working transform. gamut-color computes the same list
// in hue::range_centres and a test in gamut-gpu holds the two equal.
