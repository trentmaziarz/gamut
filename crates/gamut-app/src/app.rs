...
use gamut_media::video::is_video_path;
...
pub struct Session {
    ...
    /// came from.
    pub versions: Vec<gamut_core::NamedVersion>,
...
impl GamutApp {
    ...
    fn open_project(&mut self, loaded: LoadedProject) -> Result<(), String> {
        ...
        let crop = if loaded.project.crop.rect == gamut_core::CropRect::FULL {
...
fn pick_file() -> Option<PathBuf> {
    ...
    all.push(gamut_core::project::EXTENSION);
    rfd::FileDialog::new()
