...
use gamut_app::app::{Session, SwitchAnswer};
use gamut_app::headless::{EditSource, HeadlessError};
use gamut_app::screenshot::write_developed;
use gamut_app::sidecar::{load, save};
use gamut_core::Sidecar;
use gamut_core::look::Wheel;
use gamut_media::fixtures;

#[test]
fn two_versions_survive_a_reload_and_render_by_name() {
    let dir = std::env::temp_dir().join("gamut-versions-test");
