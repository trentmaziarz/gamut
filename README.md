...
slate is pre-release, milestone 2: a phone photo or clip opens, the Basic
...
Bugs and questions go to the issues page at github.com/trentmaziarz/slate.
...
5. Unzip the FFmpeg 9 LGPL shared build from BtbN's FFmpeg-Builds releases into a
   ...
   that folder.
6. `cargo run -p slate-app` opens the window.
